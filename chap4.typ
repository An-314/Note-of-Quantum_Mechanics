...
$
  psi = mat(a_1; a_2; dots.v; a_n; dots.v)
$
...
$
  ...
  F mat(psi_1, psi_2, dots;)
  = mat(
    psi_1^dagger;
    psi_2^dagger;
    dots.v;
  )
  mat(lambda_1 psi_1, lambda_2 psi_2, dots;)
  \
  = mat(
...
$
  mat(a_1; a_2; dots.v;)=
  mat(braket(1, psi); braket(2, psi); dots.v;)
$
